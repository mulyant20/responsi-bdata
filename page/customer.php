                ...
                <table class="table table-data">
                    ...
                    <?php foreach($customer as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row["nomor"] ?></td>
                            <td>
                                <a href="./editcustomer.php?id=<?= $row["id_customer"] ?>"><img src="../assets/img/edit.svg" alt=""></a>
                                <a href="./hapuscustomer.php?id=<?= $row["id_customer"] ?>"><img src="../assets/img/delete.svg" alt=""></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>

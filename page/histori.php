<?php
    ...
    $customer = query("SELECT * FROM log_customer");
    $arsipcustomer = query("SELECT * FROM arsipcustomer");

    $transaksi = query("SELECT * FROM log_transaksi");
    $arsiptransaksi = query("SELECT * FROM arsiptransaksi");
    
    $produk = query("SELECT * FROM log_produk");
    $arsipproduk = query("SELECT * FROM arsipproduk");
...
<body>
    ...
    <div class="main-section">
        <div class="col-left">
            ...
            <div class="row-table mt-6">
                <div class="row-title">
                    <p>Data arsip customer</p>
                </div>
                <table class="table table-data">
                    <tr>
                        <th>ID</th>
                    ...
                    <?php foreach($arsipcustomer as $row) : ?>
                        <tr>
                            <td><?= $row["id"] ?></td>
                            <td><?= $row["nama"] ?></td>
                            <td><?= $row["alamat"] ?></td>
            ...
            <div class="row-table mt-6">
                ...
                <table class="table table-data">
                    ...
                    <?php foreach($arsiptransaksi as $row) : ?>
                        <tr>
                            <td><?= $row["id_Logtransaksi"] ?></td>
                            <td><?= $row["id_customer"] ?></td>
                            <td><?= $row["tggl"] ?></td>
            ...
            <div class="row-table mt-6">
                ...
                <table class="table table-data">
                    ...
                    <?php foreach($arsipproduk as $row) : ?>
                        <tr>
                            <td><?= $row["id_Logproduk"] ?></td>
                            <td><?= $row["nama"] ?></td>
                            <td><?= $row["merek"] ?></td>
